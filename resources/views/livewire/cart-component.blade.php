        ...
        <div class=" main-content-area">
                    ...
                    <li class="pr-cart-item">
                        ...
                        <div class="quantity">
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-increase" href="#" wire:click.prevent="increaseQuantity('{{$item->rowId}}')" wire:click="$emit('updateCartCount')"></a>
                                <a class="btn btn-reduce" href="#" wire:click.prevent="decreaseQuantity('{{$item->rowId}}')" wire:click="$emit('updateCartCount')"></a>
                            </div>
                        </div>
                        <div class="price-field sub-total"><p class="price">${{$item->subtotal}}</p></div>
                        <div class="delete">
                            <a href="#" wire:click.prevent="destroy('{{$item->rowId}}')" wire:click="$emit('updateCartCount')" class="btn btn-delete" title="">
            ...
            <div class="summary">
                ...
                <div class="update-clear">
                    <a class="btn btn-clear" href="#"  wire:click.prevent="destroyAll()" wire:click="$emit('updateCartCount')">Clear Shopping Cart</a>
